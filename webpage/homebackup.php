                    ...
                    <div class="col">
                        ...
                        <div class="box-body table-responsive mt-3">
                            <table id="table" class="table table-bordered table-success table-striped table table-hover" style="width:100%">
                                ...
                                <?php
                                $status = "active";
                                    $sql = "SELECT 	clientsID, CONCAT(lastname, ', ', firstname, ' ', middlename) as cname,contactno,firstname, lastname, middlename, householdnum,age ,street,image_name,birthdate,barangay FROM tblclientinfo where status ='$status'   order by clientsID";
                                    ...
                                    <?php $image_source = basename($row['image_name'])?>
                                        ...
                                        <tr>
                                            ...
                                            <button id="edit" data-id = "<?=$row['clientsID']?>" class = "btn btn-success btn-sm edit">
                                            <i class="fas fa-pencil-alt" aria-hidden = "true"> 
                                            </i> Update </button>
                                            <!-- <button id="delete" data-id = "<?=$row['clientsID']?>" class = "btn btn-danger btn-sm delete">
                                            <i class="fas fa-trash-alt" aria-hidden = "true"> 
                                            </i> Delete </button> -->
                                            <button id="view" data-id = "<?=$row['clientsID']?>" class = "btn btn-secondary btn-sm view">
