        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <a href = "#" ><img class="mb-4" src="../img/DSWD-Logo.png"  style="height:68px;"></a> DSWD</div>
                <div class="list-group list-group-flush my-3">
                    ...
                    <a href="./Solouser.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold active"><i
        ...
        <div id="page-content-wrapper">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Solo Parent Page</h2>
                </div>
 ...
 function fetch_data(is_date_search, start_date='', end_date='', condition = '')
 {
  var dataTable = $('#order_data').DataTable({
   ...
   "ajax" : {
    ...
    type:"POST",
    data:{
     is_date_search:is_date_search, start_date:start_date, end_date:end_date, condition:"Solo Parent"
    }
   }
